 ...
 * @property integer $tahun_semester
 */
class Periode extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nama_periode, tahun, tanggal_buka, tanggal_tutup, tahun_semester', 'required'),
			array('tahun_semester, tahun', 'numerical', 'integerOnly'=>true),
			array('nama_periode', 'length', 'max'=>255),
			array('tahun_semester', 'length', 'max'=>5),
			array('tahun', 'length', 'max'=>4),
			array('status_aktivasi', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_periode, nama_periode, tahun, tanggal_buka, tanggal_tutup, status_aktivasi, tahun_semester', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('status_aktivasi',$this->status_aktivasi,true);
		$criteria->compare('tahun_semester',$this->tahun_semester);
