...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'tahun_semester'); ?>
		<small>Diisi dg format tahunsemester. Contoh : 20181</small>
		<?php echo $form->error($model,'tahun_semester'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'tahun'); ?>
		<?php echo $form->textField($model,'tahun',array('size'=>10,'maxlength'=>4)); ?>
